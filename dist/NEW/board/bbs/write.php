...
<div class="wrap Mwrap">
  <div class="bodys">
    ...
    <div class="subpage_img">
        <p class="title_ourJob"><img src="/NEW/images/kor/title_job.png" alt="job Opening"></p>      
        <div><img src="/NEW/images/kor/top_e_04.jpg" alt=""></div>
    </div>
    <div class="subpage_cont">
        <div class="locs">
            <a href="#"><img src="/NEW/images/kor/icon_house.png"></a>
            Recruitment <img src="/NEW/images/kor/icon_next.png">
            Job Openings
        </div>
...
<input type=hidden name=wr_1 value="46">

        <div class="careerProcess_box">
            <p class="serv_title"><img src="/NEW/images/kor/serv_title14.png" alt="채용공고">
                <i>채용 프로세스</i>
            </p>
            ...
            <div class="careerApply">
                <div class="carAP1"><img src="/NEW/images/kor/gae_txt1.png" alt=""></div>
                <div class="privatePolict_Box" style="overflow-y:hidden;">
                    <iframe src="/NEW/html/00_termUse_small.html" width="100%" height="187" marginwidth="0" marginheight="0" name="ferh" frameborder="0"></iframe>
                </div>
                <div class="comfit_chek" >
                    <p>
                    <input type="checkbox" id="agree1" name="agree1" value="1">
                    <span class="comfit_chek_t">본인은 [개인정보 수집 및 이용에 대한 안내]를 읽어 보았으며 내용에 동의합니다. </span>  
                    </p>     
                </div>
                <div class="carAP2"><img src="/NEW/images/kor/gae_txt2.png" alt="입사지원"></div>
                <div class="G3_tableDiv">
                    <table class="G3_table">
                        <tr>
                            <td class="g3Title">선택 채용공고</td>
                            <td><i>
Customer Success Pre-Sales 경력직 채용							</i>
							</td>
                        </tr>
                        <tr>
                            <td class="g3Title">이름</td>
                            <td><input class='input_daegiG_memNum' maxlength=20  id=wr_name name=wr_name itemname="이름" required value=""></td>
                        </tr>
                        <tr>
                            <td class="g3Title">이메일</td>
                            <td>
<input class='input_daegiG_memNum' maxlength=100 name=wr_email email itemname="이메일" required value="" style="width:200px;">
                                <!-- <input class="input_daegiG_email1" type="" name="">
                                @
                                <input class="input_daegiG_email2" type="" name="">&nbsp;
                                <select>  
                                ...
                                &nbsp;
                                <a class="emailCCC" href="#"><img src="/NEW/images/kor/btn_email.png" alt="이메일인증"></a> -->
                            </td>
                        </tr>
                        <tr>
                            <td class="g3Title">비밀번호</td>
                            <td>
							<input class="input_daegiG_memNum" type=password maxlength=20 name=wr_3 itemname="패스워드"  required>
                                <i>&nbsp;&nbsp;추후 본인 확인을 위해 필요합니다.</i>
                            </td>
                        </tr>
                        <tr>
                            <td class="g3Title">비밀번호 확인</td>
                            <td>
							<input class="input_daegiG_memNum" type=password maxlength=20 name=wr_4 itemname="패스워드"  required></td>
                        </tr>
                        <tr>
                            <td class="g3Title">지원분야</td>
                            <td>
            ...
            <select name=wr_2 id=wr_2>
						...
						<tr>
                            <td class="g3Title">지원양식 업로드 <span onclick="add_file();" style="cursor:pointer;"><img src="../skin/board/apply/img/btn_file_add.gif"></span> 
                <span onclick="del_file();" style="cursor:pointer;"><img src="../skin/board/apply/img/btn_file_minus.gif"></span></td>
                            <td><table id="variableFiles" cellpadding=0 cellspacing=0 class="none"></table>        <script type="text/javascript">
        var flen = 0;
        function add_file(delete_code)
        {
            ...
            objCell.innerHTML = "<input type='file' class='ed file_box' name='bf_file[]' title='파일 용량 10,485,760 바이트 이하만 업로드 가능'>";
            if (delete_code)
        ...
        function del_file()
        {
            ...
            if (objTbl.rows.length - 1 > file_length)
            {
                ...
                <div class="comfit_chek" >
                        ...
                        <span class="comfit_chek_t">지원서 상의 모든 기재사항은 사실과 다름이 없음을 확인합니다. </span>  
                        </p>     
                </div>
                <div class="g3_ziwonBtn">
                    <a href="#" onclick="javascript:$('#fwrite').submit();"><img src="/NEW/images/kor/btn_sends.png" alt="지원하기"></a>
                </div>
...
function fwrite_submit(f) 
{
	...
	if(f.wr_content.value == '') {
		f.wr_content.value = f.wr_name.value + " 입사 지원입니다. ";
	}

	if(f.wr_subject.value == '') {
		f.wr_subject.value = f.wr_name.value + " 입사 지원입니다. ";
	}
    ...
    */
    ...
    var content = "";
    $.ajax({
        url: "../skin/board/apply/ajax.filter.php",
        type: "POST",
        data: {
...
//    $( "#wr_2" ).datepicker({dateFormat : 'yy.mm.dd'});
  });
