...
var screenH = $(window).height();
	...
	$('.main_mission_txt').css('top',main_misIMG_H-30)
	...
	if(screenW <= 380 && screenW > 0){ 
		$('.main_img div').find('img').attr('src','../images/common/main_img2.jpg');
		$('.bodys h1').find('img').attr("src","../images/common/logo_small.png")
		$('.mobile_home_btn a').find('img').attr("src","../images/common/mobile_small_btn.png")
		$('.m_close p a img').attr("src","../images/common/mobile_x_small_btn.jpg")		
		$('.main_mission_bg').find('img').attr('src','../images/kor/main_mission_bg2.jpg');
		var main_misIMG_H2 = parseFloat( $('.main_mission_bg img').css('height') ) /2
		$('.main_img p').find('img').attr('src','../images/kor/main_txt_differ2.png');
		...
		$('.main_blue_box p').find('img').attr('src','../images/kor/main_color_txt1_.png');
		$('.main_red_box p').find('img').attr('src','../images/kor/main_color_txt2_.png');		
		$('.main_img div').find('img').attr('src','../images/common/main_img_none.jpg');
		console.log("380-0 L"+screenW)
	}
	if(screenW <= 667 && screenW > 380){ 
		$('.main_img div').find('img').attr('src','../images/common/main_img2.jpg');
		$('.bodys h1').find('img').attr("src","../images/common/logo.png")
		$('.mobile_home_btn a').find('img').attr("src","../images/common/mobile_btn.png")
		$('.m_close p a img').attr("src","../images/common/mobile_x_btn.jpg")
		$('.main_mission_bg').find('img').attr('src','../images/kor/main_mission_bg2.jpg');
		var main_misIMG_H2 = parseFloat( $('.main_mission_bg img').css('height') ) /2
		$('.main_img p').find('img').attr('src','../images/kor/main_txt_differ.png');
		...
		$('.main_img p').find('img').attr('src','../images/kor/main_txt_differ.png');
		$('.main_img p').css('marginLeft','-162px');
		$('.main_mission_bg').find('img').attr('src','../images/kor/main_mission_bg.jpg');
		$('.main_img div').find('img').attr('src','../images/common/main_img_none.jpg');
		console.log("940 Over L"+screenW)
	}if(screenW < 1600){
		$('.main_img div').find('img').attr('src','../images/common/main_img_none.jpg');
	}if(screenW >= 1600){
		$('.main_img div').find('img').attr('src','../images/common/main_img.jpg');
	}
...
$('.util_open_K a').bind("click", function(){	
	if(util == "close"){		
		...
		util = "open"
		$('.util_open_K > a > img').attr('src','../images/common/btn_A_kor_.png');
	}else if(util == "open"){
		$('#langSelect').stop().animate({height:0},200,"easeInCubic",function(){ $('#langSelect').css('display','none')})
		util = "close"
		$('.util_open_K > a > img').attr('src','../images/common/btn_A_kor.png');
	}
});
